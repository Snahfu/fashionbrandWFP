    ...
    <div class="modal-body">
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input class="form-control" type="text" placeholder="Nama" name="namaproduk" id="namaproduk" value="{{ $data->nama_produk }}" required>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Brand</label>
            <div class="col-sm-12 col-md-10">
                <input class="form-control" type="text" placeholder="Brand" name="brandproduk" id="brandproduk" value="{{ $data->brand_produk }}" required>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Harga</label>
            <div class="col-sm-12 col-md-10">
                <input class="form-control" type="number" placeholder="Harga" name="hargaproduk" id="hargaproduk" step=".01" value="{{ $data->harga }}" required>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Dimensi</label>
            <div class="col-sm-12 col-md-10">
                <input class="form-control" type="text" placeholder="Dimensi" name="dimensiproduk" id="dimensiproduk" value="{{ $data->dimensi }}" required>
            </div>
        </div>
        <div class="form-group row">
